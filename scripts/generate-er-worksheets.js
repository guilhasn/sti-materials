...
const solucaoCaso1 = {
  ...
  f5: [
    {
      ...
      fk: "PK do lado N (cota); PK do lado 1 fica como FK_",
      aplicacao: [
        "LEITOR (<u>Num_Leitor</u>, NIF, CC, nome, morada, email, contacto, observações)",
        "LIVRO (<u>cota</u>, ISBN, título, data, edição, editora)",
        "REQUISITAR (<u>cota</u>, FK_Num_Leitor)",
      ],
      nota: "PK é só 'cota' porque cada livro só está emprestado a 1 leitor de cada vez → cota é única em REQUISITAR. Num_Leitor fica apenas como FK.",
    },
    {
      ...
      fk: "Tabela da relação com PK composta (ambas PKs)",
      aplicacao: [
        "AUTOR (<u>Id_autor</u>, nome, nacionalidade, dataNascimento)",
        "ESCREVER (<u>cota</u>, <u>Id_autor</u>)",
      ],
      nota: "Em N:M a PK é composta — ambos os atributos são também FKs",
    },
  ],
  f6: [
    ...
    ["LIVRO", "cota; ISBN"],
    ["AUTOR", "Id_autor"],
    ["REQUISITAR", "cota (um livro está emprestado a 1 leitor de cada vez)"],
  ...
  f7: [
    ...
    ["REQUISITAR", "cota", "Num_Leitor repete-se (um leitor tem vários livros); cota é única (Regra 5)"],
    ["ESCREVER", "(cota, Id_autor)", "PK composta (N:M) — um autor co-assina uma vez o mesmo livro"],
  ],
  f8: [
    "LEITOR (<u>Num_Leitor</u>, NIF, CC, nome, morada, email, contacto, observações)",
    "LIVRO (<u>cota</u>, ISBN, título, data, edição, editora)",
  ...
  f5: [
    {
      ...
      aplicacao: [
        ...
        "PROCESSO (<u>numProcesso</u>, tipoObra, ..., FK_codRequerente)",
      ],
    },
    {
  ...
  f5: [
    {
      ...
      aplicacao: [
        "VIATURA (<u>matricula</u>, ..., FK_codDepartamento)",
    ...
    },
    {
      ...
      aplicacao: [
        "MOTORISTA (<u>codMotorista</u>, ..., FK_codDepartamento)",
      ],
    ...
    },
    {
      ...
      participacao: "Indiferente",
      regra: 6, numTabelas: 3,
      fk: "Tabela da relação com PK simples + duas FKs",
      aplicacao: [
        "REQUISICAO (<u>codRequisicao</u>, FK_matricula, FK_codMotorista, dataInicio, dataFim, destino, kmInicio, kmFim, estado)",
      ],
      nota: "Atributos próprios (datas, destino, km) justificam PK simples codRequisicao; FKs marcadas com prefixo FK_",
    },
    {
